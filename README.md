# Voice Notepad - Multimodal Cloud Transcription App
...
**Documentation:** [User Manual v3 (PDF)](docs/documentation/manuals/Voice-Notepad-User-Manual-v3.pdf) — Complete installation and usage guide

## About This Project

Voice Notepad is an **audio multimodal first** transcription application. The core design choice is to send audio directly to multimodal AI models (like Google Gemini) that can "hear" and process audio alongside text instructions in a single pass—rather than the traditional two-step approach of ASR followed by LLM cleanup.

This is an **experimental, iterative software design process** based on my own need for a better transcription tool. In the first few weeks of use, I've validated the approach with **over 2,000 transcriptions** and **more than 1 million characters** of output with excellent results. Development is ongoing.

### AI-Human Co-Authorship

This software was developed through AI-human collaboration. The code was generated by **Claude Opus 4.5** and other Anthropic models under my direction and supervision. I designed the architecture, specified requirements, and guided the implementation while Claude wrote the code. This represents an experimental approach to software development that I believe produces high-quality results when the human provides clear direction and domain expertise.
...
- [User Manual v3 (PDF)](docs/documentation/manuals/Voice-Notepad-User-Manual-v3.pdf) - Complete guide (v1.9.x)
- [User Manual v2 (PDF)](docs/documentation/manuals/archive/Voice-Notepad-User-Manual-v2.pdf) - Legacy guide (v1.8.0)
